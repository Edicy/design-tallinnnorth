...
<div id="body" class="clearfix wrapper">
  <div class="content-block left clearfix" data-search-indexing-allowed="true">
   <div class="excerpt clearfix content-hyphenate">
    {% editable article.excerpt %}
   </div>
   <div class="content-hyphenate">{% editable article.body %}</div>
    ...
    <ul class="content-hyphenate">{% for comment in article.comments %}
     <li class="edy-site-blog-comment">
      <strong class="comment-author">
        {{comment.author}}
        <span class="comment-date">{{comment.created_at | format_date:"short"}}</span>
        {% removebutton %}
      </strong>
